...
% add custom logos
% \headerlogoleft{\includegraphics[width=0.08\paperwidth]{assets/logo-uvt-alt.png}}
% \headerlogoright{\includegraphics[width=0.08\paperwidth]{assets/logo-hria-alt.png}}
% \headerlogoright{\qrcode[height=0.06\paperwidth]{https://github.com/alexfikl/hria-poster}}
...
\begin{block}{Obiectivul General}
